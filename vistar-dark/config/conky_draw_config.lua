...
-- ============================================================================
-- Preset 0: Default
COLOR_PRIMARY = 0xFFFFFF   -- Main accent for rings/bars
COLOR_SECONDARY = 0xFFFFFF  -- CPU individual bars
COLOR_SUCCESS = 0xFFFFFF   -- Normal state rings
COLOR_WARNING = 0xFBBF24     -- High usage warning
COLOR_CRITICAL = 0xF87171    -- Critical state
BOX_COLOR = 0x232931
BOX_APLHA = 0.75
BORDER_COLOR = 0x393E46
BORDER_THICKNESS = 2
